...
public class PazientiFrame {
	...
	public PazientiFrame(ModelloGestoreLogicaGenerale modello) {
        ...
        logoLabel.setBounds(20, 0, 155, 40);
		...
		prontoSoccorsoBottoniPanel.setBounds(0, (int) (sinistraPanel.getHeight() * 0.32), sinistraPanel.getWidth(), (int) (sinistraPanel.getHeight() * 0.65));
		...
		inserisciPazienteButton.setBounds(0, 0, prontoSoccorsoBottoniPanel.getWidth(), 34);
		...
		inserisciDiariaButton.setBounds(0, inserisciPazienteButton.getHeight(), prontoSoccorsoBottoniPanel.getWidth(), 34);
		...
		prendereCaricoBottoniPanel.setBounds(0, (int) (sinistraPanel.getHeight() * 0.32), sinistraPanel.getWidth(), (int) (sinistraPanel.getHeight() * 0.65));
		...
		assegnaLettoButton.setBounds(0, 0, prendereCaricoBottoniPanel.getWidth(), 34);
		...
		repartoBottoniPanel.setBounds(0, (int) (sinistraPanel.getHeight() * 0.32), sinistraPanel.getWidth(), (int) (sinistraPanel.getHeight() * 0.65));
		...
		modificaDiariaMedButton.setBounds(0, 0, repartoBottoniPanel.getWidth(), 34);
		...
		inserisciDiariaInfButton.setBounds(0, modificaDiariaMedButton.getHeight(), repartoBottoniPanel.getWidth(), 34);
		...
		inserisciRilevazioneButton.setBounds(0, modificaDiariaMedButton.getHeight() * 2, repartoBottoniPanel.getWidth(), 34);
		...
		visualizzaDiarieInfButton.setBounds(0, modificaDiariaMedButton.getHeight() * 4, repartoBottoniPanel.getWidth(), 34);
		...
		visualizzaRilevazioniButton.setBounds(0, modificaDiariaMedButton.getHeight() * 5, repartoBottoniPanel.getWidth(), 34);
		...
		visualizzaStoricoButton.setBounds(0, modificaDiariaMedButton.getHeight() * 6, repartoBottoniPanel.getWidth(), 34);
		...
		visualizzaFarmaciButton.setBounds(0, modificaDiariaMedButton.getHeight() * 7, repartoBottoniPanel.getWidth(), 34);
		...
		visualizzaInformazioniButton.setBounds(0, modificaDiariaMedButton.getHeight() * 8, repartoBottoniPanel.getWidth(), 34);
		...
		dimettiButton.setBounds(0, modificaDiariaMedButton.getHeight() * 9, repartoBottoniPanel.getWidth(), 34);
