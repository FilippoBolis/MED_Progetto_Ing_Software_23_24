...
public class CreateDB {
	...
	public void creaTable() throws IOException, SQLException {
		...
		if (conn != null) {
			...
			String tabellarilevazione = "CREATE TABLE RILEVAZIONE (ID TEXT , COD_DEGENTE TEXT,TEMPERATURA FLOAT, PRESSIONE INT, GLICEMIA INT, FREQ_CARD INT, DOLORE INT,PRIMARY KEY(ID,COD_DEGENTE),FOREIGN KEY(ID) REFERENCES DEGENTE (COD_DEGENTE))"; 
