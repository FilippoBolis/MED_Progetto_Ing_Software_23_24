...
public class CreateDB {
	...
	public void creaTable() throws IOException, SQLException {
		...
		if (conn != null) {
			...
			String tabelladiariamed = "CREATE TABLE DIARIAMED (CODICE TEXT, CODICE_DEGENTE TEXT, STORICO TEXT , MOTIVO TEXT, FARMACI TEXT,  ALLERGIE TEXT FOREIGN KEY (CODICE_DEGENTE) REFERENCES DEGENTE(CODICE), PRIMARY KEY (CODICE,CODICE_DEGENTE))";
			...
			String tabellarilevazione = "CREATE TABLE RILEVAZIONE (ID TEXT , CODICE_DEGENTE TEXT,TEMPERATURA FLOAT, PRESSIONE INT, GLICEMIA INT, FREQ_CARD INT, DOLORE INT,PRIMARY KEY(ID,CODICE_DEGENTE),FOREIGN KEY(CODICE_DEGENTE) REFERENCES DEGENTE (CODICE))";
