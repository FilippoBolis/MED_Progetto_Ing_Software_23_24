...
public class CreateDB {
	...
	public void creaTable() throws IOException, SQLException {
		...
		if (conn != null) {
			...
			String tabelladiariamed = "CREATE TABLE DIARIAMED (CODICE TEXT, CODICE_DEGENTE TEXT, CODICE_MEDICO TEXT, STORICO TEXT , MOTIVO TEXT, FARMACI TEXT,DATA DATE,  ALLERGIE TEXT, FOREIGN KEY (CODICE_DEGENTE) REFERENCES DEGENTE(CODICE), PRIMARY KEY (CODICE,CODICE_DEGENTE))";
