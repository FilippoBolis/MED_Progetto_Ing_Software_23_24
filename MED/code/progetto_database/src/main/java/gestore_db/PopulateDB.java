...
public class PopulateDB {
	...
	public static void main(String[] args) throws Exception{
		...
		InserimentoJooq.getIstanza().diariaMed(1,"D2","m","Il paziente soffre di un forte allergia", "Attacco allergico","Medicina Interna", "Antiallergene", LocalDate.now(), LocalTime.now().withNano(0), "Allergia ad alcuni farmaci");
