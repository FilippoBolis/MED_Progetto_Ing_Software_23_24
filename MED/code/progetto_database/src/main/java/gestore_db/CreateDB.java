...
public class CreateDB {
	...
	public void creaTable() throws IOException, SQLException {
		...
		if (conn != null) {
			...
			String tabellaRilevazione = "CREATE TABLE RILEVAZIONE (ID INT , CODICE_DEGENTE TEXT,TEMPERATURA DOUBLE,PRESSIONE_MAX INT, PRESSIONE_MIN INT, GLICEMIA INT ,DATA DATE,ORA TIME, FREQ_CARD INT, DOLORE INT,PRIMARY KEY(ID,CODICE_DEGENTE),FOREIGN KEY(CODICE_DEGENTE) REFERENCES DEGENTE (CODICE))";
