...
public class CreateDB {
	...
	public void creaTable() throws IOException, SQLException {
		...
		if (conn != null) {
			...
			String tabellaDegente = "CREATE TABLE DEGENTE (CODICE TEXT, NOME TEXT, COGNOME TEXT, SESSO TEXT, DATA_ARRIVO DATE, ORA_ARRIVO TIME, URGENZA INT, IN_ATTESA BOOLEAN, PRIMARY KEY (CODICE))";
