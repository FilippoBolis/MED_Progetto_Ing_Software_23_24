...
public class CreateDB {
	...
	public void creaTable() throws IOException, SQLException {
		...
		if (conn != null) {
			...
			String tabellaPersonale = "CREATE TABLE PERSONALE (CODICE TEXT, NOME TEXT, COGNOME TEXT, MANSIONE TEXT, PASSWORD TEXT, PRIMARY KEY(CODICE,PASSWORD))";
			String tabellaDegente = "CREATE TABLE DEGENTE (CODICE TEXT, NOME TEXT, COGNOME TEXT, SESSO TEXT, DATA_ARRIVO DATE, ORA_ARRIVO TIME, URGENZA TEXT, POSIZIONE TEXT, PRIMARY KEY (CODICE))";
			String tabellaDiariaInf = "CREATE TABLE DIARIAINF (CODICE INT, CODICE_DEGENTE TEXT, CODICE_INFERMIERE TEXT, DATA DATE, ORA TIME, NOTE_PARTICOLARI TEXT, IMPORTANTE BOOLEAN, FARMACO TEXT, FOREIGN KEY (CODICE_DEGENTE) REFERENCES DEGENTE(CODICE), PRIMARY KEY (CODICE,CODICE_DEGENTE))";
			String tabellaDiariaMed = "CREATE TABLE DIARIAMED (CODICE INT, CODICE_DEGENTE TEXT, CODICE_MEDICO TEXT, STORICO TEXT , MOTIVO TEXT, REPARTO_CONSIGLIATO TEXT, FARMACI TEXT,DATA DATE,ORA TIME, ALLERGIE TEXT, FOREIGN KEY (CODICE_DEGENTE) REFERENCES DEGENTE(CODICE), PRIMARY KEY (CODICE,CODICE_DEGENTE))";
			...
			String tabellaRilevazione = "CREATE TABLE RILEVAZIONE (ID INT , CODICE_DEGENTE TEXT, CODICE_INFERMIERE TEXT, TEMPERATURA DOUBLE,PRESSIONE_MAX INT, PRESSIONE_MIN INT, GLICEMIA INT ,DATA DATE,ORA TIME, FREQ_CARD INT, DOLORE INT,PRIMARY KEY(ID,CODICE_DEGENTE),FOREIGN KEY(CODICE_DEGENTE) REFERENCES DEGENTE (CODICE))";
