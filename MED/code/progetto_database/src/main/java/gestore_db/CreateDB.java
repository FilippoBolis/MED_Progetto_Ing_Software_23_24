...
public class CreateDB {
	...
	public void creaTable() throws IOException, SQLException {
		...
		if (conn != null) {
			...
			String tabellaDiariaMed = "CREATE TABLE DIARIAMED (CODICE TEXT, CODICE_DEGENTE TEXT, CODICE_MEDICO TEXT, STORICO TEXT , MOTIVO TEXT, REPARTO_CONSIGLIATO TEXT, FARMACI TEXT,DATA DATE,ORA TIME, ALLERGIE TEXT, FOREIGN KEY (CODICE_DEGENTE) REFERENCES DEGENTE(CODICE), PRIMARY KEY (CODICE,CODICE_DEGENTE))";
