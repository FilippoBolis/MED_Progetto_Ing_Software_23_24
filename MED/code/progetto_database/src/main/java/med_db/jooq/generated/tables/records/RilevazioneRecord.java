...
public class RilevazioneRecord extends UpdatableRecordImpl<RilevazioneRecord> implements Record10<String, String, Double, Integer, Integer, Integer, LocalDate, LocalTime, Integer, Integer> {
    ...
    @Override
    public Row10<String, String, Double, Integer, Integer, Integer, LocalDate, LocalTime, Integer, Integer> valuesRow() {
    ...
    @Override
    public RilevazioneRecord value1(String value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public RilevazioneRecord values(String value1, String value2, Double value3, Integer value4, Integer value5, Integer value6, LocalDate value7, LocalTime value8, Integer value9, Integer value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RilevazioneRecord(String id, String codiceDegente, Double temperatura, Integer pressioneMax, Integer pressioneMin, Integer glicemia, LocalDate data, LocalTime ora, Integer freqCard, Integer dolore) {
        super(Rilevazione.RILEVAZIONE);
